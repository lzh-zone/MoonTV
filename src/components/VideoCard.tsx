...
export default function VideoCard({
  ...
  return (
    <div
      className='group relative w-full rounded-xl bg-transparent transition-all duration-300 ease-in-out hover:z-[500] p-2 hover:glass-card glass-hover'
      onClick={handleClick}
    >
      {/* 海报容器 */}
      ...
      <div className='mt-3 text-center'>
        <div className='relative'>
          <span className='block text-sm font-bold truncate text-gray-800 dark:text-gray-100 transition-colors duration-300 ease-in-out group-hover:text-sky-600 dark:group-hover:text-sky-400 peer'>
            {actualTitle}
          </span>
          {/* 自定义 tooltip */}
          <div className='absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-1 bg-gray-800/90 backdrop-blur-md text-white text-xs rounded-md shadow-lg opacity-0 invisible peer-hover:opacity-100 peer-hover:visible transition-all duration-200 ease-out delay-100 whitespace-nowrap pointer-events-none z-50'>
            {actualTitle}
        ...
        {config.showSourceName && source_name && (
          <span className='block text-xs text-gray-500 dark:text-gray-400 mt-1.5'>
            <span className='inline-block border rounded-md px-2 py-0.5 border-gray-400/40 dark:border-gray-500/40 bg-gray-50/50 dark:bg-gray-800/50 backdrop-blur-sm transition-all duration-300 ease-in-out group-hover:border-sky-500/60 group-hover:text-sky-600 dark:group-hover:text-sky-400'>
              {source_name}
            </span>
          </span>
        )}
